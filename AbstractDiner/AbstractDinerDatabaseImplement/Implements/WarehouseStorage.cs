...
namespace AbstractDinerDatabaseImplement.Implements
{
    public class WarehouseStorage : IWarehouseStorage
    {
        ...
        private Warehouse CreateModel(WarehouseBindingModel model, Warehouse warehouse, AbstractDinerDatabase context)
        {
        ...
        public void CheckAndWriteOff(SnackViewModel model, int countInOrder)
        {
            using (var context = new AbstractDinerDatabase())
            {
                using (var transaction = context.Database.BeginTransaction())
                {
                    ...
                    foreach (var snackComponent in model.SnackComponents)
                    {
